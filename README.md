...
## Summary
This is a business analysis of a proposed partner for expansion into the Brazilian market. The data used for this project comes as a self-contained MySQL dump file and can be downloaded [here](https://drive.google.com/uc?export=download&id=1Y6fWPUQrMofINrIV1X2pIQNcTv-1H2CF).
